...
function onCreate()
		...
		for i = 0, getProperty('unspawnNotes.length')-1 do
			...
			if getPropertyFromGroup('unspawnNotes', i, 'mustPress') and getPropertyFromGroup('unspawnNotes', i, 'noteType') == 'allbf_Sing' then
				...
				setPropertyFromGroup('unspawnNotes', i, 'noAnimation', false); --Make it so Dad doesn't do animation
